...
** New Java class VSXPairHMM

We will create a new Java class src_java{VSXPairHmm} to provide the
...
#+begin_src java :tangle VSXLoglessPairHmm.java :comments org
    ///
    /// {@inheritDoc}
    ///
